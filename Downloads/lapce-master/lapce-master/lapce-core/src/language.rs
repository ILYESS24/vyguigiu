...
use aurion_rpc::style::{LineStyle, Style};
...
/// indices into the LANGUAGES array.  See method `Aurion IDELanguage::properties`.
///
...
/// `Aurion IDELanguage` as they will be accessed using the enum variants as indices.
const LANGUAGES: &[SyntaxProperties] = &[
    // Undetected/unmatched fallback or just plain file
    SyntaxProperties {
        id: Aurion IDELanguage::PlainText,
        indent: Indent::tab(),
        files: &[],
        extensions: &["txt"],
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Beancount,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Dockerfile,
        indent: Indent::space(2),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Gitattributes,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::GitCommit,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::GitConfig,
        indent: Indent::tab(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::GitRebase,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::GoTemplate,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Javascript,
        indent: Indent::space(2),
        files: &[],
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::KotlinBuildScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["kts"],
        comment: CommentProperties {
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Markdown,
        indent: Indent::space(4),
        files: &[],
        extensions: &["md"],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::MarkdownInline,
        indent: Indent::space(4),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::OcamlInterface,
        indent: Indent::space(2),
        files: &[],
        extensions: &["mli"],
        comment: comment_properties!("(*"),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::PowerShell,
        indent: Indent::space(4),
        files: &[],
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::ProtoBuf,
        indent: Indent::space(2),
        files: &[],
        extensions: &["proto"],
        comment: comment_properties!("//"),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::ShellScript,
        indent: Indent::space(2),
        files: &[],
        extensions: &["sh"],
        comment: comment_properties!("#"),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::SshClientConfig,
        indent: Indent::tab(),
        files: &[],
        extensions: &[],
        comment: comment_properties!(),
    ...
    SyntaxProperties {
        id: Aurion IDELanguage::Typescript,
        indent: Indent::space(4),
        files: &[],
...
impl Aurion IDELanguage {
    ...
    pub fn from_path(path: &Path) -> Aurion IDELanguage {
        Self::from_path_raw(path).unwrap_or(Aurion IDELanguage::PlainText)
    }

    pub fn from_path_raw(path: &Path) -> Option<Aurion IDELanguage> {
    ...
    pub fn from_name(name: &str) -> Option<Aurion IDELanguage> {
        match Aurion IDELanguage::from_str(name.to_lowercase().as_str()) {
            Ok(v) => Some(v),
            Err(e) => {
                event!(Level::DEBUG, "failed parsing `{name}` Aurion IDELanguage: {e}");
                None
            }
        }
    }
    ...
    fn get_grammar(&self) -> Option<tree_sitter::Language> {
        ...
        if let Some(grammars_dir) = Directory::grammars_directory() {
            match self::load_grammar(&grammar_name, &grammar_fn_name, &grammars_dir)
            {
                ...
                Err(err) => {
                    if self != &Aurion IDELanguage::PlainText {
...
mod tests {
    ...
    use super::Aurion IDELanguage;

    #[test]
    fn test_lanaguage_from_path() {
        let l = Aurion IDELanguage::from_path(&PathBuf::new().join("test.rs"));
        assert_eq!(l, Aurion IDELanguage::Rust);
    }
}
