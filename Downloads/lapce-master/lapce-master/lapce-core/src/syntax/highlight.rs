...
use crate::{language::Aurion IDELanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<Aurion IDELanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
