...
pub enum CommandKind {
    Workbench(Aurion IDEWorkbenchCommand),
    Edit(EditCommand),
    Move(MoveCommand),
...
pub fn Aurion IDE_internal_commands() -> IndexMap<String, Aurion IDECommand> {
    let mut commands = IndexMap::new();

    for c in Aurion IDEWorkbenchCommand::iter() {
        let command = Aurion IDECommand {
...
pub enum Aurion IDEWorkbenchCommand {
    ...
    #[strum(message = "About Aurion IDE")]
    ShowAbout,
    ...
    #[cfg(target_os = "macos")]
    #[strum(message = "Install Aurion IDE to PATH")]
    #[strum(serialize = "install_to_path")]
    InstallToPATH,

    #[cfg(target_os = "macos")]
    #[strum(message = "Uninstall Aurion IDE from PATH")]
