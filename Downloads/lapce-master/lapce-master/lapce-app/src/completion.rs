...
use aurion_rpc::{plugin::PluginId, proxy::ProxyRpcHandler};
use lsp_types::{
...
use crate::{config::Aurion IDEConfig, editor::EditorData, snippet::Snippet};
...
impl CompletionData {
    pub fn new(cx: Scope, config: ReadSignal<Arc<Aurion IDEConfig>>) -> Self {
...
fn completion_lens_text(
    ...
    // Get only the first line of text, because Aurion IDE does not currently support
