...
use aurion_core::mode::{Mode, Modes};
...
use crate::{
    command::{CommandExecuted, CommandKind, Aurion IDECommand, Aurion IDE_internal_commands},
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, Aurion IDECommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<Aurion IDECommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &Aurion IDEConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(Aurion IDE_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &Aurion IDEConfig) {
