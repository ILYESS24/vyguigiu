...
pub struct Aurion IDEColor {}

impl Aurion IDEColor {
    pub const Aurion IDE_WARN: &'static str = "Aurion IDE.warn";
    pub const Aurion IDE_ERROR: &'static str = "Aurion IDE.error";
    pub const Aurion IDE_DROPDOWN_SHADOW: &'static str = "Aurion IDE.dropdown_shadow";
    pub const Aurion IDE_BORDER: &'static str = "Aurion IDE.border";
    pub const Aurion IDE_SCROLL_BAR: &'static str = "Aurion IDE.scroll_bar";

    pub const Aurion IDE_BUTTON_PRIMARY_BACKGROUND: &'static str =
        "Aurion IDE.button.primary.background";
    pub const Aurion IDE_BUTTON_PRIMARY_FOREGROUND: &'static str =
        "Aurion IDE.button.primary.foreground";

    pub const Aurion IDE_TAB_ACTIVE_BACKGROUND: &'static str =
        "Aurion IDE.tab.active.background";
    pub const Aurion IDE_TAB_ACTIVE_FOREGROUND: &'static str =
        "Aurion IDE.tab.active.foreground";
    pub const Aurion IDE_TAB_ACTIVE_UNDERLINE: &'static str =
        "Aurion IDE.tab.active.underline";

    pub const Aurion IDE_TAB_INACTIVE_BACKGROUND: &'static str =
        "Aurion IDE.tab.inactive.background";
    pub const Aurion IDE_TAB_INACTIVE_FOREGROUND: &'static str =
        "Aurion IDE.tab.inactive.foreground";
    pub const Aurion IDE_TAB_INACTIVE_UNDERLINE: &'static str =
        "Aurion IDE.tab.inactive.underline";

    pub const Aurion IDE_TAB_SEPARATOR: &'static str = "Aurion IDE.tab.separator";

    pub const Aurion IDE_ICON_ACTIVE: &'static str = "Aurion IDE.icon.active";
    pub const Aurion IDE_ICON_INACTIVE: &'static str = "Aurion IDE.icon.inactive";

    pub const Aurion IDE_REMOTE_ICON: &'static str = "Aurion IDE.remote.icon";
    pub const Aurion IDE_REMOTE_LOCAL: &'static str = "Aurion IDE.remote.local";
    pub const Aurion IDE_REMOTE_CONNECTED: &'static str = "Aurion IDE.remote.connected";
    pub const Aurion IDE_REMOTE_CONNECTING: &'static str = "Aurion IDE.remote.connecting";
    pub const Aurion IDE_REMOTE_DISCONNECTED: &'static str = "Aurion IDE.remote.disconnected";

    pub const Aurion IDE_PLUGIN_NAME: &'static str = "Aurion IDE.plugin.name";
    pub const Aurion IDE_PLUGIN_DESCRIPTION: &'static str = "Aurion IDE.plugin.description";
    pub const Aurion IDE_PLUGIN_AUTHOR: &'static str = "Aurion IDE.plugin.author";
