...
use aurion_rpc::terminal::TermId;

use super::kind::PanelKind;
use crate::{
    app::clickable_icon,
    command::{InternalCommand, Aurion IDEWorkbenchCommand},
...
fn terminal_tab_header(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    stack((
        ...
        container(clickable_icon(
            || Aurion IDEIcons::ADD,
            move || {
                workbench_command.send(Aurion IDEWorkbenchCommand::NewTerminalTab);
            },
            || false,
            || false,
            || "New Terminal",
