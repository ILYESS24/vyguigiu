        ...
        RunDebugMode::Debug => container(stack((
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || Aurion IDEIcons::DEBUG_CONTINUE,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || Aurion IDEIcons::DEBUG_STEP_OVER,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || Aurion IDEIcons::DEBUG_STEP_INTO,
                    move || {
            ...
            },
            {
                let terminal = terminal.clone();
                clickable_icon(
                    || Aurion IDEIcons::DEBUG_STEP_OUT,
                    move || {
                ...
                stack((
                    {
                        let svg_str = match (&p.mode, p.stopped) {
                            (RunDebugMode::Run, false) => Aurion IDEIcons::START,
                            (RunDebugMode::Run, true) => Aurion IDEIcons::RUN_ERRORS,
                            (RunDebugMode::Debug, false) => Aurion IDEIcons::DEBUG,
                            (RunDebugMode::Debug, true) => {
                                Aurion IDEIcons::DEBUG_DISCONNECT
                            }
                        };
                        ...
                        s.items_center()
                            ...
                            .hover(|s| {
                                s.apply_if(reference > 0, |s| {
                                    s.background(
                                        config.get().color(
                                            Aurion IDEColor::PANEL_HOVERED_BACKGROUND,
                                        ),
                                    )
                                })
                            })
                ...
                .style(move |s| {
                    ...
                    s.padding_left(20.0)
                        ...
                        .apply_if(!has_source, |s| {
                            s.color(config.color(Aurion IDEColor::EDITOR_DIM))
                        })
                        .hover(|s| {
                            s.background(
                                config.color(Aurion IDEColor::PANEL_HOVERED_BACKGROUND),
