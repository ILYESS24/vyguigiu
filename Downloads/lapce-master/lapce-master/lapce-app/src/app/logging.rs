...
pub(super) fn logging() -> (Handle<Targets>, Option<WorkerGuard>) {
    ...
    let log_file_filter_targets = filter::Targets::new()
        .with_target("aurion_app", LevelFilter::DEBUG)
        .with_target("aurion_proxy", LevelFilter::DEBUG)
        .with_target("aurion_core", LevelFilter::DEBUG)
    ...
    let console_filter_targets = std::env::var("Aurion IDE_LOG")
        .unwrap_or_default()
