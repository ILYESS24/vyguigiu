...
use aurion_proxy::dispatch::Dispatcher;
use aurion_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: aurion_rpc::core::CoreNotification) {
    ...
    fn handle_request(
        &mut self,
        _id: aurion_rpc::RequestId,
        _rpc: aurion_rpc::core::CoreRequest,
    ) {
    }
}
